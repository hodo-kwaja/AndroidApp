    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                ...
                Log.d("0번","0번: "+List.get(0));
                Log.d("1번","1번: "+List.get(1));
                Log.d("2번","2번: "+List.get(2));
                Log.d("3번","3번: "+List.get(3));

                JSONObject obj =new JSONObject();
                try {
                    obj.put("departure",List.get(0));
                    obj.put("arrival",List.get(1));
                    obj.put("now",List.get(2));
                    obj.put("week",List.get(3));
